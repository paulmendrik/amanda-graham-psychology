...
export default async (context, inject) => {
  ...
  let api = {}
  try {
    api = await Prismic.api('https://amanda-blog.cdn.prismic.io/api/v2', Object.assign({}, options,  {}))
  } catch (error) {
    console.error(error)
  ...
  if (process.client) {
    window.onNuxtReady && window.onNuxtReady(() => {
      ...
      script.src = '//static.cdn.prismic.io/prismic.min.js?repo=amanda-blog&new=true'
