...
import nuxt_plugin_NuxtVuikit_be7894f4 from 'nuxt_plugin_NuxtVuikit_be7894f4' // Source: ./Nuxt-Vuikit.js (mode: 'all')
...
import nuxt_plugin_icons_7c16f112 from 'nuxt_plugin_icons_7c16f112' // Source: ./pwa/icons.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_NuxtVuikit_be7894f4 === 'function') {
    await nuxt_plugin_NuxtVuikit_be7894f4(app.context, inject)
  }

  if (typeof nuxt_plugin_prismic_553bb724 === 'function') {
    await nuxt_plugin_prismic_553bb724(app.context, inject)
  }

  if (typeof nuxt_plugin_prismiccomponents_06eebcc7 === 'function') {
    await nuxt_plugin_prismiccomponents_06eebcc7(app.context, inject)
  }
  ...
  if (typeof nuxt_plugin_staticplugin058d2a52_00bf9dda === 'function') {
    await nuxt_plugin_staticplugin058d2a52_00bf9dda(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_workbox_67e800fc === 'function') {
    await nuxt_plugin_workbox_67e800fc(app.context, inject)
  }

  if (typeof nuxt_plugin_meta_48deb7b8 === 'function') {
    await nuxt_plugin_meta_48deb7b8(app.context, inject)
  }

  if (typeof nuxt_plugin_icons_7c16f112 === 'function') {
    await nuxt_plugin_icons_7c16f112(app.context, inject)
  }
